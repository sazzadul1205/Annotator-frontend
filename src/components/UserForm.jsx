    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 pr-24"
            required={!isEditMode}
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-xs font-medium bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg transition whitespace-nowrap flex items-center gap-1"
              disabled={isLoading}
            >
      ...
      <div className="flex gap-3 pt-2">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors duration-200 font-medium disabled:opacity-50"
          disabled={isLoading}
        >
          Cancel
        </button>
