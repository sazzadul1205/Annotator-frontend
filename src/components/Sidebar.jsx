    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 shrink-0">
            <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
          </div>
          <div className="min-w-0">
            <h2 className="text-base sm:text-xl font-bold bg-blue-400 bg-clip-text text-transparent truncate">
              Annotator
            </h2>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-xl p-2.5 sm:p-3 border border-white/10">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-500 flex items-center justify-center text-xs font-bold shadow-lg shrink-0">
      ...
      <div className="p-3 border-t border-gray-700/50">
        <button
          ...
          className="w-full group flex items-center justify-center gap-2 px-3 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 rounded-xl text-sm"
        >
